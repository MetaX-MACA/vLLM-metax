...
try:
    ...
    pytest.skip("mm_encoder_attention fp8 constants not available", allow_module_level=True)
try:
    from vllm.utils.flashinfer import (
        is_flashinfer_cudnn_fp8_prefill_attn_supported,
    )
except ImportError:
    pytest.skip("flashinfer cudnn fp8 not available", allow_module_level=True)
