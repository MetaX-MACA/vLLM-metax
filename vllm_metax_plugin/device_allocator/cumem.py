...
try:
    from vllm_metax_plugin.cumem_allocator import (init_module, python_create_and_map,
                                      python_unmap_and_release)
    from vllm_metax_plugin.distributed.device_communicators.cuda_wrapper import (
        CudaRTLibrary)
