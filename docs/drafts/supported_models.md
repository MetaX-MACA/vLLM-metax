...
| Architecture | Models | Example HF Models | [LoRA](https://docs.vllm.ai/en/stable/features/lora.html) | [PP](https://docs.vllm.ai/en/stable/serving/parallelism_scaling.html) |Use Models example|
|--------------|--------|-------------------|----------------------|---------------------------|---------------------------|
...
| Architecture | Models | Inputs | Example HF Models | [LoRA](https://docs.vllm.ai/en/stable/features/lora.html) | [PP](https://docs.vllm.ai/en/stable/serving/parallelism_scaling.html) |Use Models example|
|--------------|--------|--------|-------------------|----------------------|---------------------------|---------------------------|
...
| `Qwen3VLForConditionalGeneration` | Qwen3-VL | T + I<sup>E+</sup> + V<sup>E+</sup> | `Qwen/Qwen3-VL-4B-Instruct`, etc. | ✅︎ | ✅︎ |./examples/offline_inference/qwen3vl_2b.py|
