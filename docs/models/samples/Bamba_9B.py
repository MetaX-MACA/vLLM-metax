...
import sys
import torchvision
torchvision.disable_beta_transforms_warning() # adding this to suppress a warning from import of vllm
...
def main():
    ...
    parser.add_argument("--model", default="ibm-ai-platform/Bamba-9B", help="Model name or path.")
