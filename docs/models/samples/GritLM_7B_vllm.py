...
def main():
    ...
    parser.add_argument("--model", default="parasail-ai/GritLM-7B-vllm", help="Model name or path.")
    ...
    llm = LLM(
        ...
        task="generate" # GritLM requires the task to be explicitly set to "generate"
    )
