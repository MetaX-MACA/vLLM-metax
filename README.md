...
- **releases/vX.Y.Z**: release branch, created when a new version of vLLM is released. For example, `releases/v0.14.0` is the release branch for vLLM `v0.14.0` version. (Same tag name)
...
| Branch      | Status       | Note                                 |
|-------------|--------------|--------------------------------------|
| releases/v0.14.0 | Released | related to vllm release v0.13.0 |
