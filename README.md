...
- **releases/vX.Y.Z**: release branch, created when a new version of vLLM is released. For example, `releases/v0.12.0` is the release branch for vLLM `v0.12.0` version. (Same tag name)
- **vX.Y.Z-dev**: development branch, created with part of new releases of vLLM. For example, `v0.13.0-dev` is the dev branch for vLLM `v0.13.0` version.
...
Please check [here](https://vllm-metax.readthedocs.io/en/v0.12.0/getting_started/quickstart.html) for v0.12.0 details.
