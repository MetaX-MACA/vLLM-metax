...
from typing import Any, TYPE_CHECKING, ClassVar, Generic, TypeVar, cast
...
from vllm.model_executor.layers.attention.mla_attention import (
    logger,
    unified_mla_kv_cache_update,  # noqa: F401
)
...
# ---------------------------------------------
# Use vllm's unified_mla_attention custom_op
...
class _DecodeConcatQuantFP8(QuantFP8):
    """not implemented in maca"""

    def forward_oot(self, *args, **kwargs):
        raise NotImplementedError("This method is not implemented in maca")
...
class MLACommonImpl(MLAAttentionImpl[M], Generic[M]):
    ...
    def __init__(
        ...
        # ----------------------------------------------
        # Note: flashinfer-metax does not support this kernel
        ...
        if use_trtllm_ragged_deepseek_prefill():
            ...
            # /-----------------------------------------------------------
            # Note: maca flash_attn_varlen_func does not have `fa_version`
            # ------------------------------------------------------------
    ...
    def _compute_prefill_context(
        ...
        for i in range(iters):
            ...
            if not use_fp8_prefill:
                ...
                raise AssertionError("FP8 Prefill path should not be triggered")
