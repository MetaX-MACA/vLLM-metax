...
from vllm.model_executor.layers.attention.mla_attention import logger
...
def _get_kv_b_proj_input_dtype(
    ...
    if weight_dtype == torch.int8:
        # w8a8_int8 do their own dequantization as well, so we don't need to quantize the input.
        return None
