...
def metax_inplace_fused_experts(hidden_states: torch.Tensor,
                          w1: torch.Tensor,
                          w2: torch.Tensor,
...
def metax_outplace_fused_experts(
    ...
    return metax_fused_experts_impl(hidden_states, w1, w2, topk_weights, topk_ids,
...
class TritonExperts(mk.FusedMoEPermuteExpertsUnpermute):
    ...
    def apply(
        ...
        metax_invoke_fused_moe_kernel(hidden_states,
                                w1,
                                intermediate_cache1,
                                a1q_scale,
                                w1_scale,
