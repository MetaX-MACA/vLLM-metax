...
def invoke_fused_moe_wna16_triton_kernel(
    ...
    # Triton kernel "fused_moe_kernel_gptq_awq" has been moved to mcoplib 
    # since mx/v0.15.0-dev according to MC3-7114.
    fused_moe_triton_kernel_gptq_awq(
        grid,
        A,
        B,
...
def invoke_fused_moe_triton_kernel(
    ...
    if use_int8_w8a8 and mx_envs.MACA_VLLM_ENABLE_MCTLASS_FUSED_MOE:
        ...
        # Triton kernel "fused_moe_kernel" has been moved to mcoplib 
        # since mx/v0.15.0-dev according to MC3-7114.
        fused_moe_triton_kernel(
            grid=grid,
            a_ptr=A,
...
def get_default_config(
    ...
    if dtype == "fp8_w8a8" and block_shape is not None:
        ...
        config = {
            ...
            "SPLIT_K": 1,
            "num_warps": 4,
            "num_stages": 3 if not current_platform.is_rocm() else num_stages_maca,
        }
