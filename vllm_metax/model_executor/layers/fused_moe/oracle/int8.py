...
from vllm_metax.patch.bugfix.int8_moe_gemm1_params.fused_moe_config import (
...
class Int8MoeBackend(Enum):
    TRITON = "TRITON"
    DEEPGEMM = "DEEPGEMM"  # TODO(Hank): Support on v0.27.0 for ag_rs backend (maybe)
...
def select_int8_moe_backend(
    ...
    # Handle explicit DeepGEMM configuration. Note: Int8 MoE only has a
    # batched (deep_ep) DeepGEMM backend, no standard-format variant.
