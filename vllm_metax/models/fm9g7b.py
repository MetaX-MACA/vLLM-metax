...
from .fm9g import FM9GMLP, fm9g_model_invariants


class FM9G7BAttention(nn.Module):
...
class FM9G7BDecoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.self_attn = FM9G7BAttention(
...
class FM9GModel(nn.Module):
    ...
    def __init__(
        ...
        self.start_layer, self.end_layer, self.layers = make_layers(
            ...
            lambda prefix: FM9G7BDecoderLayer(
                config,
                prefix=prefix,
                cache_config=cache_config,
                quant_config=quant_config,
...
class FM9G7BForCausalLM(nn.Module, SupportsPP, SupportsEagle3, SupportsLoRA):
