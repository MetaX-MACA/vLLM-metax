...
from vllm_metax.customized.pluggable_layer.deepseek_v4_attention import (
    ...
    MacaDeepseekV4MultiHeadLatentAttentionWrapper as DeepseekV4MultiHeadLatentAttentionWrapper,
)
...
class DeepseekV4MegaMoEExperts(nn.Module):
    ...
    def forward(
        ...
        *,
        ...
        torch.ops.vllm.mx_deepseek_v4_mega_moe_experts(
            hidden_states,
            topk_weights,
            topk_ids,
            y,
...
direct_register_custom_op(
    op_name="mx_deepseek_v4_mega_moe_experts",
...
class DeepseekV4DecoderLayer(nn.Module):
    def __init__(
        ...
        import vllm_metax.model_executor.layers.mhc  # noqa: F401
