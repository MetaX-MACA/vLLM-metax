...
try:
    ...
    # \------------------------- Metax Modification -------------------------/
    logger.info("cudnn_batch_prefill_with_kv_cache is not supported in Metax.")
...
def use_cudnn_prefill() -> bool:
    logger.info("cudnn prefill is not supported in Metax.")
    return False
    # /------------------------  Metax Modification -------------------------\
...
class MLACommonImpl(MLACommonBaseImpl[M], Generic[M]):
    ...
    def _forward_prefill(
        ...
        # TODO: need to check if this is supported on maca
