...
# from vllm.v1.outputs import EMPTY_MODEL_RUNNER_OUTPUT, AsyncModelRunnerOutput, ModelRunnerOutput, make_empty_encoder_model_runner_output
if TYPE_CHECKING:
        ...
        if spec_config is not None:
            ...
            if not input_fits_in_drafter:
                raise RuntimeError(
                    ...
                    f"drafter_max_model_len {self.effective_drafter_max_model_len}, "
