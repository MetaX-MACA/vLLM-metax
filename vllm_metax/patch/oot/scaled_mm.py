...
if mx_envs.MACA_VLLM_ENABLE_MCTLASS_PYTHON_API:
    from vllm_metax.model_executor.layers.quantization import _python_api_ops as mx_ops
else:
    from vllm_metax.model_executor.layers.quantization import _cutlass_ops as mx_ops
