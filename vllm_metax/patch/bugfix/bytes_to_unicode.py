...
import transformers.models.gpt2.tokenization_gpt2 as _gpt2_tokenization
...
if not hasattr(_gpt2_tokenization, "bytes_to_unicode"):
    _gpt2_tokenization.bytes_to_unicode = _bytes_to_unicode
