...
def _patch_qwen3_5_mtp_loader() -> None:
    marker = "_metax_qwen3_5_original_load_weights"
    if hasattr(AutoWeightsLoader, marker):
        return
    ...
    # /-------------------- Metax Modification ---------------------\
    setattr(AutoWeightsLoader, marker, original_load_weights)
    AutoWeightsLoader.load_weights = load_weights
    # \-------------------------------------------------------------/


_patch_qwen3_5_mtp_loader()
