...
from vllm.model_executor.layers.rotary_embedding.llama4_vision_rope import (
...
from vllm.model_executor.layers.rotary_embedding.phi3_long_rope_scaled_rope import (
